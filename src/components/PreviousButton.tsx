...
const PreviousButton: React.FC<PreviousButtonProps> = ({ onClick, className = "" }) => {
  return (
    <button
      onClick={onClick}
    ...
    >
      <svg width="180" height="48" viewBox="0 0 180 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto max-w-[180px]">
