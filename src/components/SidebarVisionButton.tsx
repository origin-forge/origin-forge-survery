...
interface SidebarVisionButtonProps {
  onClick: () => void;
  className?: string;
  isActive?: boolean;
}

const SidebarVisionButton: React.FC<SidebarVisionButtonProps> = ({ onClick, className = "", isActive = false }) => {
  return (
    <button
      onClick={onClick}
...
export default SidebarVisionButton;