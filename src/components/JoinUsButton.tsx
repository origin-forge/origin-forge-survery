...
const JoinUsButton: React.FC<JoinUsButtonProps> = ({ onClick, className = "", isActive = false }) => {
  return (
    <button
      onClick={onClick}
    ...
    >
      <svg width="200" height="48" viewBox="0 0 200 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto max-w-[200px]">
