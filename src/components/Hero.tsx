            ...
            <div className="relative z-10 flex flex-col w-full h-full pt-16 pb-8 px-4 sm:px-8 md:px-16 lg:px-24">
                ...
                <div className="w-full max-w-4xl mb-2 sm:mb-4">
                    ...
                    >
                        ...
                        >
                            ...
                            <span
                                className="whitespace-nowrap text-yellow-400 text-[6vw] sm:text-[4vw] md:text-[3vw] lg:text-[2.2vw] xl:text-[2vw] font-bold text-center tracking-[0.13em] leading-[1.1]"
                                style={{
                                    WebkitTextStroke: '1px #222',
                                    textShadow: 'none',
                                    maxWidth: '100vw',
                ...
                <div className="flex flex-col sm:flex-row flex-wrap gap-4 sm:gap-6 justify-start items-center sm:items-start mt-8 mb-6 sm:mb-10 w-full max-w-2xl">
                    ...
                    <div className="w-full sm:w-auto flex justify-center sm:block">
                        <a 
                            href="/learn" 
                            className="inline-block hover:opacity-90 transition-transform hover:scale-110"
                            style={{
                                width: '95vw',
                                maxWidth: '240px',
                                height: '54px',
