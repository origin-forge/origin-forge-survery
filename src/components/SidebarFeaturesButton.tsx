...
interface SidebarFeaturesButtonProps {
  onClick: () => void;
  className?: string;
  isActive?: boolean;
}

const SidebarFeaturesButton: React.FC<SidebarFeaturesButtonProps> = ({ onClick, className = "", isActive = false }) => {
  return (
    <button
      onClick={onClick}
...
export default SidebarFeaturesButton;