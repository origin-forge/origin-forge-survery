...
interface SidebarJoinUsButtonProps {
  onClick: () => void;
  className?: string;
  isActive?: boolean;
}

const SidebarJoinUsButton: React.FC<SidebarJoinUsButtonProps> = ({ onClick, className = "", isActive = false }) => {
  return (
    <button
      onClick={onClick}
...
export default SidebarJoinUsButton;