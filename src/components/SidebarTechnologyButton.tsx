...
interface SidebarTechnologyButtonProps {
  onClick: () => void;
  className?: string;
  isActive?: boolean;
}

const SidebarTechnologyButton: React.FC<SidebarTechnologyButtonProps> = ({ onClick, className = "", isActive = false }) => {
  return (
    <button
      onClick={onClick}
...
export default SidebarTechnologyButton;