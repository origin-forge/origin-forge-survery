...
interface OurMissionButtonProps {
  onClick: () => void;
  className?: string;
  isActive?: boolean;
}

const OurMissionButton: React.FC<OurMissionButtonProps> = ({ onClick, className = "", isActive = false }) => {
  return (
    <button
      onClick={onClick}
    ...
    >
      <svg width="260" height="48" viewBox="0 0 260 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto max-w-[260px]">
        <rect x="6.5" width="247" height="48" rx="24" fill="#2D2D2D" stroke="#FFD700" strokeWidth="2"/>
